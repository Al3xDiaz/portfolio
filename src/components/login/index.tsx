          ...
          display:!signupShow?"none":"block"
            ...
            <form>
              <div className='row'>
                ...
                <Form.Password id='login-password' error={loginInValidate && !loginDataForm?.password} onChange={value=>setLoginDataForm({...loginDataForm,password:value})}/>
          ...
          display:signupShow?"none":"block"
            ...
            <form>
              <div className='row'>
                ...
                <Form.Password id='signup-password' onChange={value=>setSignUpDataForm({...signUpDataForm,password:value})} />
                <Form.Password id='signup-password-confirm' label='Confirm Password' onChange={value=>setSignUpDataForm({...signUpDataForm,confirmpassword:value})} />
